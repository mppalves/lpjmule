...
dataset_info = list(
  ...
  years = 149,
  bands = 32,
  soilcells = T, #True (59199 cells), False (67420 cells)
  monthly = F,
  input_levels = c(seq(0, 2.0, 0.2), 2.5),
  rel = "0.5-to-c200_area_weighted_mean.spam"
)
```
...
dataset_info = list(
  ...
  #readLPJ specific variables more information on readLPJ
...
harverst.df <- training_warper("/p/projects/landuse/users/pedrosa/ML_gym/inputs/elevated",dataset_info = dataset_info)
